...
def test_get_questionnaires_calls_the_rest_api_client_with_the_correct_parameters(_mock_rest_api_client, blaise_service, questionnaire_list):
    # arrange
...
@mock.patch.object(blaise_restapi.Client, "get_all_questionnaires_for_server_park")
def test_get_questionnaires_logs_an_error_if_exception_occurs(_mock_rest_api_client, blaise_service, caplog):
    # arrange
...
@mock.patch.object(blaise_restapi.Client, "get_all_questionnaires_for_server_park")
def test_get_names_of_questionnaire_in_blaise_returns_the_expected_names_for_survey_types(_mock_rest_api_client, blaise_service, questionnaire_list):
    # arrange
    _mock_rest_api_client.return_value = questionnaire_list
    survey_type = "LMS"
