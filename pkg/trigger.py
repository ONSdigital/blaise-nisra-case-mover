...
def trigger_processor(
    ...
    topic_path = publisher_client.topic_path(config.project_id, config.processor_topic_name)
...
def get_filtered_instruments(sftp: SFTP, case_mover: CaseMover, survey_source_path: str) -> Dict[str, Instrument]:
